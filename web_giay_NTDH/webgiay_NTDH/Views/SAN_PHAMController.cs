...
namespace webgiay_NTDH.Controllers
{
    public class SAN_PHAMController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductID,Ten_san_pham,Mo_ta,So_luong_ton_kho,Thuong_hieu,Hinh_anh,Mau,Kich_thuoc,Gia")] SAN_PHAM sAN_PHAM)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductID,Ten_san_pham,Mo_ta,So_luong_ton_kho,Thuong_hieu,Hinh_anh,Mau,Kich_thuoc,Gia")] SAN_PHAM sAN_PHAM)
        {
            if (ModelState.IsValid)
            {
