...
namespace webgiay_NTDH.Controllers
{
    public class DON_HANGController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderID,customerID,Ngay_dat_hang,Tong_tien,Dia_chi,Phuong_thuc_thanh_toan,Ma_theo_doi")] DON_HANG dON_HANG)
        {
            ...
            ViewBag.customerID = new SelectList(db.KHACH_HANG, "MaKH", "Ho_ten", dON_HANG.customerID);
            return View(dON_HANG);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderID,customerID,Ngay_dat_hang,Tong_tien,Dia_chi,Phuong_thuc_thanh_toan,Ma_theo_doi")] DON_HANG dON_HANG)
        {
            if (ModelState.IsValid)
            {
